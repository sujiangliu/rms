...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath %>/common/swfupload/swfupload.js"></script>
		<script type="text/javascript" src="<%=basePath %>/common/swfupload/swfupload.queue.js"></script>
		<script type="text/javascript" src="<%=basePath %>/common/swfupload/handlers.js"></script>
		<script type="text/javascript">
			...
			window.onload = function () {
				swfu = new SWFUpload({
					...
					// Flash Settings
					flash_url : "<%=basePath %>/common/swfupload/swfupload.swf",
